...
<div class="uk-container">
  <div data-uk-grid="">
    <div class="uk-width-1-2@s">
      <div><img class="uk-border-rounded-large" src="photo-1557038684-abb03178899e" alt="Image alt"></div>
    </div>
        ...
        <div class="uk-article">
          ...
          <div id="step-1" class="uk-grid-small uk-margin-medium-top" data-uk-grid="">
            <div class="uk-width-auto">
              <a href="#" class="uk-step-icon" data-uk-icon="icon: check; ratio: 0.8" data-uk-toggle="target: #step-1; cls: uk-step-active"></a>
            </div>
          ...
          <div id="step-2" class="uk-grid-small uk-margin-medium-top" data-uk-grid="">
            <div class="uk-width-auto">
              <a href="#" class="uk-step-icon" data-uk-icon="icon: check; ratio: 0.8" data-uk-toggle="target: #step-2; cls: uk-step-active"></a>
            </div>
            <div class="uk-width-expand">
          ...
          <div id="step-3" class="uk-grid-small uk-margin-medium-top" data-uk-grid="">
            <div class="uk-width-auto">
              <a href="#" class="uk-step-icon" data-uk-icon="icon: check; ratio: 0.8" data-uk-toggle="target: #step-3; cls: uk-step-active"></a>
            </div>
            <div class="uk-width-expand">
          ...
          <div id="step-4" class="uk-grid-small uk-margin-medium-top" data-uk-grid="">
            <div class="uk-width-auto">
              <a href="#" class="uk-step-icon" data-uk-icon="icon: check; ratio: 0.8" data-uk-toggle="target: #step-4; cls: uk-step-active"></a>
            </div>
            <div class="uk-width-expand">
              ...
              <article class="uk-comment uk-visible-toggle" tabindex="-1">
                <header class="uk-comment-header uk-position-relative">
                  <div class="uk-grid-medium uk-flex-middle" data-uk-grid="">
                    <div class="uk-width-auto">
                      <img class="uk-comment-avatar uk-border-circle" src="photo-1521146764736-56c929d59c83" width="50" height="50" alt="Alice Thomson">
                    </div>
                    <div class="uk-width-expand">
                ...
                <li>
                  <article class="uk-comment uk-comment-primary uk-visible-toggle uk-border-rounded" tabindex="-1">
                    <header class="uk-comment-header uk-position-relative">
                      <div class="uk-grid-medium uk-flex-middle" data-uk-grid="">
                        <div class="uk-width-auto">
                          <img class="uk-comment-avatar uk-border-circle" src="photo-1545167622-3a6ac756afa4" width="50" height="50" alt="Tom Solender">
                        </div>
                        <div class="uk-width-expand">
